...
if st.session_state.uploaded_file is not None:
    ...
    with col1:
        st.button('HR Interview Questions', on_click=show_hr_questions)
    with col2:
        st.button('Technical Interview Questions', on_click=show_technical_questions)
    ...
    if st.session_state.show_hr:
        ...
        with st.spinner('Generating HR questions...'):
            hr_questions = get_hr_questions(st.session_state.file_details, st.session_state.job_description)
    ...
    if st.session_state.show_technical:
        ...
        with st.spinner('Generating Technical questions...'):
            technical_questions = get_technical_questions(st.session_state.file_details, st.session_state.job_description)
